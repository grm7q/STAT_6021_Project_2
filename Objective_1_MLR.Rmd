...
Calculating the $R^2_{prediction}$, the final model might be able to explain 58.18% of the variability in the new observations (as long as they are not rural facilities >200 beds). The R2 is 0.6457. Both values are fairly close to each other, so overfitting is not a major concern.
